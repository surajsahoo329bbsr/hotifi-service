...
public class AuthenticationErrorCodes extends ErrorCodes {
    ...
    public static final ErrorCode PHONE_ALREADY_EXISTS = new ErrorCode("08", Collections.singletonList(getMessage("PHONE_ALREADY_EXISTS", AuthenticationErrorMessages.PHONE_ALREADY_EXISTS)), 500);
