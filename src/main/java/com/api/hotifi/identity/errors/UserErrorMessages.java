...
public class UserErrorMessages extends ErrorMessages {
    public static final String FACEBOOK_USER_EXISTS = "Facebook user exists";
    ...
    public static final String USER_UPI_NOT_ADDED = "User Upi Id not added";
    ...
    public static final String USER_FREEZED = "User freezed";
    ...
    public static final String USER_DELETED = "User already deleted";
