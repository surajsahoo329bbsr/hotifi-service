...
public class PurchaseErrorCodes extends ErrorCodes {
    ...
    public static final ErrorCode UPI_PAYMENT_NULL_ERROR =  new ErrorCode("14", Collections.singletonList(getMessage("UPI_PAYMENT_NULL_ERROR", PurchaseErrorMessages.UPI_PAYMENT_NULL_ERROR)), 500);
}
