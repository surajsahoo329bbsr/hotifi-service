...
public class SellerPaymentErrorMessages {
    ...
    public static final String NO_SELLER_PAYMENT_EXISTS = "No seller payment exists";
    ...
    public static final String MINIMUM_WITHDRAWAL_AMOUNT_ERROR = "Minimum withdrawal is " + Constants.MINIMUM_WITHDRAWAL_AMOUNT;
