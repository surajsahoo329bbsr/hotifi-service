...
public class SellerBankAccountErrorCodes extends ErrorCodes {
    ...
    public static final ErrorCode NO_ERROR_DESCRIPTION_ON_LINKED_ACCOUNT = new ErrorCode("02", Collections.singletonList(getMessage("NO_ERROR_DESCRIPTION_ON_LINKED_ACCOUNT", SellerBankAccountErrorMessages.NO_ERROR_DESCRIPTION_ON_LINKED_ACCOUNT)), 500);
